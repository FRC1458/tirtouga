...
public class I2CMagnetometer extends edu.wpi.first.wpilibj.SensorBase {
	...
	public void setCalibration(int xC, int yC, int xS, int yS) {
		...
		xScale = xS;
		yScale = yS;
		SmartDashboard.putNumber("xCentre using", xCentre);
		SmartDashboard.putNumber("yCentre using", yCentre);
		SmartDashboard.putNumber("xScale using", xScale);
		SmartDashboard.putNumber("yScale using", yScale);
		zero();
	}
